...
export const content: PostContent = {
 ...
 "blocks": [
  ...
  {
   "t": "p",
   "text": "It is one of the most difficult parts for any person to recover from surgery. No matter if it is small or a large operation, the human body needs time to recover well. In this case **Post Surgery Rehabilitation** plays an important role. It is a well defined program which helps patients to regain strength, movement, and daily activities after surgery."
  },
  {
   "t": "h2",
   "text": "What Is Post Surgery Rehabilitation?"
  },
  {
   "t": "p",
   "text": "Post Surgery Rehabilitation is a process which helps patients to recover with their movement and strength after surgery. It covers physiotherapy, exercises and sometimes psychological support. The goal is to help the patient move again, avoid problems, and live a better life."
  },
  {
   "t": "h3",
   "text": "Why Is Physiotherapy Important After Surgery?"
  },
  {
   "t": "p",
  ...
  {
   "t": "h3",
   "text": "Types of Post Surgery Rehabilitation Treatments"
  },
  {
   "t": "p",
   "text": "**1.Knee Pain Treatment:** Knee surgeries, including knee replacement or ligament repair, require rehabilitation for a full recovery. [**Knee pain treatment**](/knee-pain-treatment-in-ahmedabad/) includes:"
  },
  {
   "t": "ul",
   "items": [
  ...
  {
   "t": "p",
   "text": "**2\\. Shoulder Pain Treatment:** Surgeries like rotator cuff repair or shoulder replacement demand proper rehabilitation to regain full movement. [**Shoulder pain treatment**](/shoulder-pain-treatment-doctor-in-ahmedabad/) focuses on:"
  },
  {
   "t": "ul",
   "items": [
    "Gentle stretching to restore mobility.",
    "Strength-building exercises to support the shoulder joint.",
    "Posture correction to avoid future injuries.",
    "Pain relief techniques like electrical stimulation and heat therapy."
   ]
  },
  {
   "t": "p",
   "text": "**3\\. Spinal Cord Treatment:** Spinal surgeries, such as those for herniated discs or spinal cord injuries, require specialized rehabilitation. [**Spinal cord treatment**](/spinal-cord-specialist-in-ahmedabad/) includes:"
  },
  {
   "t": "ul",
   "items": [
    ...
    "Gait training and balance exercises for mobility restoration.",
    "Pain management techniques like hydrotherapy and electrotherapy."
   ]
  },
  {
   "t": "h3",
   "text": "The Stages of Post Surgery Rehabilitation"
  },
  {
   "t": "p",
   "text": "Rehabilitation is typically divided into different phases, each focusing on specific goals:"
  },
  {
   "t": "ul",
   "items": [
  ...
  {
   "t": "h3",
   "text": "Why Is Post Surgery Rehabilitation Necessary?"
  },
  {
   "t": "p",
