...
export const content: PostContent = {
 ...
 "blocks": [
  ...
  {
   "t": "p",
   "text": "Physiotherapists help to improve quality of life by addressing physical difficulties related to mobility, strength, and functionality. Whether recuperating from an injury, managing chronic diseases, or improving physical performance, a physiotherapist is essential. Their experience is essential at all phases of life and for a variety of conditions. Here’s why we need physiotherapists:"
  },
  {
   "t": "h2",
   "text": "The Need for a Physiotherapist in Life"
  },
  {
   "t": "ul",
   "items": [
    "**Recovery from Injuries and Surgery:** Help with recovery after fractures, ligament tears, or joint replacements by restoring strength, flexibility, and range of motion in damaged areas.",
  ...
  {
   "t": "h3",
   "text": "Criteria for Selecting Top Physiotherapists"
  },
  {
   "t": "p",
   "text": "When selecting a top physiotherapist, many important factors must be considered to ensure best treatment and care."
  },
  {
   "t": "p",
  ...
  {
   "t": "p",
   "text": "**Patient feedback and testimonials**: It can provide significant information about their expertise and the level of service they provide."
  },
  {
   "t": "p",
  ...
  {
   "t": "p",
   "text": "**Technology and facilities:** A well-equipped clinic with modern equipment can improve treatment outcomes."
  },
  {
   "t": "p",
   "text": "A quality physiotherapist should prioritize communication and individualized care to make you feel heard and supported throughout your recovery."
  },
  {
   "t": "p",
   "text": "Clinic’s reputation and accessibility, such as how easily appointments can be scheduled, the availability of follow-up care, and how easy it is to reach the clinic."
  },
  {
   "t": "p",
  ...
  {
   "t": "h3",
   "text": "Why Dr. Hardik Patel and Dr. Foram Patel are top Physiotherapists in Ahmedabad?"
  },
  {
   "t": "p",
  ...
  {
   "t": "h3",
   "text": "Complete care - Top Physiotherapy Center in Ahmedabad"
  },
  {
   "t": "p",
