...
export const content: PostContent = {
 ...
 "blocks": [
  ...
  {
   "t": "p",
   "text": "Sports injuries vary based on the sport and activity, although certain injuries are common to many different types of physical activities. Below are some of the most prevalent sports injuries:"
  },
  {
   "t": "ul",
   "items": [
  ...
  {
   "t": "p",
   "text": "Sports injuries can be emotionally and physically exhausting, which requires a personalized recovery plan. Here's an overview of some of the most effective physiotherapy treatments for common sports injuries:"
  },
  {
   "t": "ul",
   "items": [
    ...
    "**Gait Analysis:** Assessing an athlete’s walking or running pattern can assist in discovering irregularities that may lead to injury. [**Best Physiotherapists**](/best-physiotherapist-in-ahmedabad/) utilize this information to recommend technique or footwear changes.",
