...
export const Route = createFileRoute("/class-iv-laser-therapy-clinic-in-ahmedabad")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://completecare.in/assets/heroes/img03-1024x683.webp" },
      { name: "twitter:image", content: "https://completecare.in/assets/heroes/img03-1024x683.webp" },
    ],
  }),
