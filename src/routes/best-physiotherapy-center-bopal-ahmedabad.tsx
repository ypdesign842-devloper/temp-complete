...
export const Route = createFileRoute("/best-physiotherapy-center-bopal-ahmedabad")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://completecare.in/assets/clinics/south%20bopal%20clinic%20image.jpeg" },
      { name: "twitter:image", content: "https://completecare.in/assets/clinics/south%20bopal%20clinic%20image.jpeg" },
    ],
  }),
