...
export const Route = createFileRoute("/spine-decompression-therapy-treatment-in-ahmedabad")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://completecare.in/assets/heroes/img01-1024x576.webp" },
      { name: "twitter:image", content: "https://completecare.in/assets/heroes/img01-1024x576.webp" },
    ],
  }),
