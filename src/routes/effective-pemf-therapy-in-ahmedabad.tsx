...
export const Route = createFileRoute("/effective-pemf-therapy-in-ahmedabad")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://completecare.in/assets/treatments/PEMF-Therapy.webp" },
      { name: "twitter:image", content: "https://completecare.in/assets/treatments/PEMF-Therapy.webp" },
    ],
  }),
