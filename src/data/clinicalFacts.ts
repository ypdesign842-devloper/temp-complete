...
const specificFactsBySlug: Record<string, [HeroFact, HeroFact, HeroFact, HeroFact]> = {
  ...
  "neck-pain-treatment-doctor-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Assessment & hands-on care", icon: "Clock" },
    { label: "TYPICAL VISITS", value: "6–12 Sessions", subtext: "Based on cervical assessment", icon: "Calendar" },
    { label: "EXPECTED RELIEF", value: "2–3 Weeks", subtext: "Progressive pain reduction", icon: "TrendingUp" },
  ...
  "back-pain-doctor-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Spinal assessment & therapy", icon: "Clock" },
    { label: "TYPICAL VISITS", value: "8–14 Sessions", subtext: "Phased treatment plan", icon: "Calendar" },
  ...
  "knee-pain-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Joint therapy & exercises", icon: "Clock" },
    { label: "TYPICAL VISITS", value: "8–15 Sessions", subtext: "Depends on joint stage / injury", icon: "Calendar" },
    { label: "RECOVERY TIMELINE", value: "3–6 Weeks", subtext: "Cartilage support & strength", icon: "TrendingUp" },
  ...
  "shoulder-pain-treatment-doctor-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Scapular & rotator cuff work", icon: "Clock" },
    { label: "TYPICAL VISITS", value: "6–12 Sessions", subtext: "Tailored to impingement stage", icon: "Calendar" },
  ...
  "frozen-shoulder-treatment-doctor-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Capsular stretching & mobilisations", icon: "Clock" },
    { label: "TYPICAL VISITS", value: "10–18 Sessions", subtext: "Stage-specific care plan", icon: "Calendar" },
  ...
  "sciatica-pain-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Spine decompression & nerve work", icon: "Clock" },
    { label: "TYPICAL VISITS", value: "8–16 Sessions", subtext: "Until radiation subsides", icon: "Calendar" },
    { label: "RECOVERY TIMELINE", value: "2–4 Weeks Initial Relief", subtext: "Progressive nerve desensitisation", icon: "TrendingUp" },
  ...
  "slipped-herniated-disc-physiotherapy-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "50–60 Minutes", subtext: "Computerised traction & rehab", icon: "Clock" },
    { label: "TYPICAL VISITS", value: "12–20 Sessions", subtext: "US-FDA disc protocol", icon: "Calendar" },
    { label: "RECOVERY TIMELINE", value: "3–6 Weeks Phased Care", subtext: "Disc retraction & nerve release", icon: "TrendingUp" },
  ...
  "ankle-pain-treatment-doctor-in-ahmedabad": [
    { label: "SESSION DURATION", value: "40–50 Minutes", subtext: "Ligament & balance training", icon: "Clock" },
    { label: "TYPICAL VISITS", value: "6–10 Sessions", subtext: "Acute to return-to-walk", icon: "Calendar" },
    { label: "RECOVERY TIMELINE", value: "2–4 Weeks", subtext: "Stability & swelling reduction", icon: "TrendingUp" },
  ...
  "best-doctor-for-tennis-elbow-in-ahmedabad": [
    { label: "SESSION DURATION", value: "35–45 Minutes", subtext: "Tendon loading & therapy", icon: "Clock" },
    { label: "TYPICAL VISITS", value: "6–10 Sessions", subtext: "Based on chronicity", icon: "Calendar" },
    { label: "RECOVERY TIMELINE", value: "3–5 Weeks", subtext: "Grip strength & tendon healing", icon: "TrendingUp" },
  ...
  "top-rheumatoid-arthritis-specialist-in-ahmedabad": [
    { label: "SESSION DURATION", value: "40–50 Minutes", subtext: "Gentle joint protection", icon: "Clock" },
  ...
  "sports-physiotherapist-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "High-performance rehab", icon: "Clock" },
    { label: "TYPICAL VISITS", value: "6–14 Sessions", subtext: "Injury to return-to-sport", icon: "Calendar" },
  ...
  "top-vertigo-specialist-in-ahmedabad": [
    { label: "SESSION DURATION", value: "30–45 Minutes", subtext: "Vestibular assessment & manoeuvres", icon: "Clock" },
    { label: "TYPICAL VISITS", value: "3–6 Sessions", subtext: "Often fast symptomatic resolution", icon: "Calendar" },
    { label: "RECOVERY TIMELINE", value: "1–2 Weeks", subtext: "Gaze stability & dizziness clear", icon: "TrendingUp" },
  ...
  "osteoporosis-treatment-doctor-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–50 Minutes", subtext: "Safe bone-loading exercise", icon: "Clock" },
  ...
  "spinal-cord-specialist-in-ahmedabad": [
    { label: "SESSION DURATION", value: "60–75 Minutes", subtext: "Intensive 1-on-1 neuro therapy", icon: "Clock" },
  ...
  "stroke-in-treatment-ahmedabad": [
    { label: "SESSION DURATION", value: "60–75 Minutes", subtext: "One-on-one motor retraining", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "12–24+ Sessions", subtext: "Early recovery window priority", icon: "Calendar" },
  ...
  "parkinson-disease-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Amplitude & balance drills", icon: "Clock" },
  ...
  "muscular-dystrophy-doctor-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Gentle contracture prevention", icon: "Clock" },
  ...
  "multiple-sclerosis-treatment-doctor-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Fatigue-monitored rehabilitation", icon: "Clock" },
  ...
  "cerebral-palsy-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "50–60 Minutes", subtext: "Paediatric motor development", icon: "Clock" },
  ...
  "bells-palsy-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "35–45 Minutes", subtext: "Facial muscle stimulation", icon: "Clock" },
    { label: "TYPICAL VISITS", value: "6–12 Sessions", subtext: "Until facial symmetry returns", icon: "Calendar" },
    { label: "RECOVERY TIMELINE", value: "3–6 Weeks", subtext: "Facial nerve regeneration", icon: "TrendingUp" },
  ...
  "diabetic-neuropathy-treatment-doctor-in-ahmedabad": [
    { label: "SESSION DURATION", value: "40–50 Minutes", subtext: "Sensory & circulation therapy", icon: "Clock" },
    { label: "TYPICAL VISITS", value: "8–14 Sessions", subtext: "Progressive nerve support", icon: "Calendar" },
  ...
  "effective-pemf-therapy-in-ahmedabad": [
    { label: "SESSION DURATION", value: "30–45 Minutes", subtext: "Pulsed electromagnetic waves", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "8–15 Sessions", subtext: "Cumulative cellular healing", icon: "Calendar" },
  ...
  "spine-decompression-therapy-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "40–50 Minutes", subtext: "Computerized axial cycle", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "10–20 Sessions", subtext: "US-FDA approved table protocol", icon: "Calendar" },
  ...
  "class-iv-laser-therapy-clinic-in-ahmedabad": [
    { label: "SESSION DURATION", value: "20–30 Minutes", subtext: "Deep-tissue photon energy", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "6–10 Sessions", subtext: "Accelerated cellular ATP", icon: "Calendar" },
    { label: "EXPECTED EFFECT", value: "Rapid Anti-Inflammatory", subtext: "Pain relief from 1st-2nd session", icon: "TrendingUp" },
    { label: "CARE APPROACH", value: "Class IV High-Power Laser", subtext: "Dual wavelength deep therapy", icon: "Zap" },
  ],
  "tecar-physiotherapy-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "30–40 Minutes", subtext: "Capacitive & resistive diathermy", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "6–10 Sessions", subtext: "Targeted endogenous heat", icon: "Calendar" },
  ...
  "best-electro-therapy-in-ahmedabad": [
    { label: "SESSION DURATION", value: "30–45 Minutes", subtext: "Custom electrotherapy suite", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "6–12 Sessions", subtext: "Paired with active exercise", icon: "Calendar" },
  ...
  "best-ift-treatment-center-in-ahmedabad": [
    { label: "SESSION DURATION", value: "20–30 Minutes", subtext: "Interferential 4-pole therapy", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "6–10 Sessions", subtext: "Acute to chronic pain phases", icon: "Calendar" },
  ...
  "effective-tens-treatment-in-ahmedabad-for-pain-relief": [
    { label: "SESSION DURATION", value: "20–30 Minutes", subtext: "Sensory nerve stimulation", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "5–10 Sessions", subtext: "Used during rehab phases", icon: "Calendar" },
  ...
  "top-short-wave-diathermy-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "20–30 Minutes", subtext: "High-frequency deep heat", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "6–10 Sessions", subtext: "Before manual mobilisations", icon: "Calendar" },
  ...
  "best-electrical-stimulation-therapy-in-ahmedabad": [
    { label: "SESSION DURATION", value: "25–35 Minutes", subtext: "Targeted motor nerve activation", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "8–15 Sessions", subtext: "Muscle re-education plan", icon: "Calendar" },
  ...
  "ultra-sound-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "15–25 Minutes", subtext: "1MHz / 3MHz acoustic soundwaves", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "5–8 Sessions", subtext: "Targeted soft tissue injury", icon: "Calendar" },
  ...
  "infra-radiation-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "15–20 Minutes", subtext: "Therapeutic infrared warmth", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "5–8 Sessions", subtext: "Pre-treatment muscle relaxing", icon: "Calendar" },
  ...
  "effective-traction-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "25–35 Minutes", subtext: "Cervical / lumbar distraction", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "8–12 Sessions", subtext: "Calibrated weight traction", icon: "Calendar" },
  ...
  "best-pneumatic-compression-therapy-in-ahmedabad": [
    { label: "SESSION DURATION", value: "30–45 Minutes", subtext: "Sequential pneumatic sleeves", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "6–12 Sessions", subtext: "Lymphatic & post-workout", icon: "Calendar" },
  ...
  "paraffin-wax-bath-therapy-in-ahmedabad": [
    { label: "SESSION DURATION", value: "20–30 Minutes", subtext: "Warm therapeutic paraffin wax", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "6–10 Sessions", subtext: "Hands, wrists, feet & ankles", icon: "Calendar" },
  ...
  "leading-osteopathy-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Whole-body biomechanical care", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "4–8 Sessions", subtext: "Structural alignment review", icon: "Calendar" },
  ...
  "top-dry-needling-therapy-services-in-ahmedabad": [
    { label: "SESSION DURATION", value: "25–35 Minutes", subtext: "Targeted myofascial trigger points", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "3–6 Sessions", subtext: "Fast muscular release", icon: "Calendar" },
  ...
  "manual-therapy-near-me-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Hands-on joint & soft tissue", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "6–12 Sessions", subtext: "Integrated with exercise rehab", icon: "Calendar" },
  ...
  "expert-kinesio-tape-therapy-in-ahmedabad": [
    { label: "SESSION DURATION", value: "20–30 Minutes", subtext: "Application & functional check", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "3–5 Days Wear Time", subtext: "Re-applied per activity need", icon: "Calendar" },
  ...
  "top-instrumented-soft-tissue-mobilization-in-ahmedabad": [
    { label: "SESSION DURATION", value: "25–35 Minutes", subtext: "Stainless steel ergonomic tools", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "4–8 Sessions", subtext: "Fascial remodelling protocol", icon: "Calendar" },
  ...
  "best-cupping-therapy-in-ahmedabad": [
    { label: "SESSION DURATION", value: "25–35 Minutes", subtext: "Negative pressure suction cups", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "4–8 Sessions", subtext: "Integrated into rehab care", icon: "Calendar" },
  ...
  "top-fitness-centre-courses-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Physio-designed workouts", icon: "Clock" },
    { label: "PROGRAM FORMAT", value: "Monthly Membership", subtext: "3–5 sessions per week", icon: "Calendar" },
  ...
  "best-aerobics-classes-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Cardio & rhythmic movement", icon: "Clock" },
    { label: "PROGRAM FORMAT", value: "Group & Personal", subtext: "3–4 days weekly routine", icon: "Calendar" },
  ...
  "step-aerobics-physiotherapy-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–50 Minutes", subtext: "Platform step choreography", icon: "Clock" },
  ...
  "hiit-training-workouts-in-ahmedabad": [
    { label: "SESSION DURATION", value: "35–45 Minutes", subtext: "High-intensity interval bursts", icon: "Clock" },
  ...
  "top-strength-training-studio-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Progressive resistance load", icon: "Clock" },
    { label: "PROGRAM FORMAT", value: "Personalized Regimen", subtext: "3–4 days weekly", icon: "Calendar" },
  ...
  "zumba-classes-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–55 Minutes", subtext: "High-energy dance fitness", icon: "Clock" },
    { label: "PROGRAM FORMAT", value: "Fun Group Sessions", subtext: "3–5 days weekly", icon: "Calendar" },
  ...
  "pilates-studio-ahmedabad": [
    { label: "SESSION DURATION", value: "45–55 Minutes", subtext: "Core stabilization & posture", icon: "Clock" },
    { label: "PROGRAM FORMAT", value: "Mat & Equipment", subtext: "2–3 sessions per week", icon: "Calendar" },
  ...
  "best-power-yoga-classes-ahmedabad": [
    { label: "SESSION DURATION", value: "50–60 Minutes", subtext: "Dynamic vinyasa flow", icon: "Clock" },
    { label: "PROGRAM FORMAT", value: "Structured Batches", subtext: "3–5 days weekly", icon: "Calendar" },
  ...
  "ball-band-training-physiotherapy-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "40–50 Minutes", subtext: "Swiss ball & resistance bands", icon: "Clock" },
  ...
  "stretching-physiotherapy-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "35–45 Minutes", subtext: "Assisted PNF & static stretching", icon: "Clock" },
    { label: "PROGRAM FORMAT", value: "Targeted Sessions", subtext: "2–3 times weekly", icon: "Calendar" },
  ...
  "female-fitness-trainer-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Dedicated female fitness session", icon: "Clock" },
  ...
  "online-fitness-classes": [
    { label: "SESSION DURATION", value: "45–50 Minutes", subtext: "Live interactive HD video", icon: "Clock" },
  ...
  "chiropractic-treatment-in-ahmedabad": [
    { label: "SESSION DURATION", value: "30–45 Minutes", subtext: "Spinal assessment & adjustments", icon: "Clock" },
    { label: "TYPICAL COURSE", value: "4–8 Sessions", subtext: "Based on spinal misalignment", icon: "Calendar" },
  ...
  "physiotherapy-at-home-in-ahmedabad": [
    { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Full clinical care at your home", icon: "Clock" },
...
export function getHeroClinicalFacts(
  ...
  switch (page.group) {
    case "condition-ortho":
      return [
        { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Comprehensive assessment & care", icon: "Clock" },
        { label: "TYPICAL VISITS", value: "6–12 Sessions", subtext: "Based on joint & tissue stage", icon: "Calendar" },
    ...
    case "condition-neuro":
      return [
        { label: "SESSION DURATION", value: "50–70 Minutes", subtext: "One-on-one motor retraining", icon: "Clock" },
    ...
    case "modality":
      return [
        { label: "SESSION DURATION", value: "25–40 Minutes", subtext: "Targeted therapeutic modality", icon: "Clock" },
        { label: "TYPICAL COURSE", value: "6–12 Sessions", subtext: "Cumulative cellular healing", icon: "Calendar" },
    ...
    case "fitness":
      return [
        { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Doctor-guided conditioning", icon: "Clock" },
    ...
    default:
      return [
        { label: "SESSION DURATION", value: "45–60 Minutes", subtext: "Personalized clinical session", icon: "Clock" },
